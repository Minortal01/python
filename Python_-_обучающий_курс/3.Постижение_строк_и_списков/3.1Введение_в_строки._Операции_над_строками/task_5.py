...
# Определить булевы значения для оператора
# in проверки вхождения первого слова во второе.
# А также для операторов ==, >, <. Все булевы значения объединить в одну строку
